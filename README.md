...
```bash
wget -qO- https://github.com/aybabtme/godotto/releases/download/0.2.6/dorepl_linux.tar.gz | tar xvz
```

### darwin

```bash
wget -qO- https://github.com/aybabtme/godotto/releases/download/0.2.6/dorepl_darwin.tar.gz | tar xvz
```
...
```bash
https://github.com/aybabtme/godotto/releases/download/0.2.6/dorepl_windows.zip
```
